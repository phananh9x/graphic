...
class Main extends Component {
    ...
    draw3D = async () => {
        ...
        x1 = Draw.convertCoordinateX(parseInt((x + cd / 2) - (z + cr / 2) * a));
        y1 = Draw.convertCoordinateY(parseInt(y - (z + cr / 2) * a));

        x2 = Draw.convertCoordinateX(parseInt((x - cd / 2) - (z + cr / 2) * a));
        y2 = Draw.convertCoordinateY(parseInt(y - (z + cr / 2) * a));

        x3 = Draw.convertCoordinateX(parseInt((x - cd / 2) - (z - cr / 2) * a));
        y3 = Draw.convertCoordinateY(parseInt(y - (z - cr / 2) * a));

        x4 = Draw.convertCoordinateX(parseInt((x + cd / 2) - (z - cr / 2) * a));
        y4 = Draw.convertCoordinateY(parseInt(y - (z - cr / 2) * a));
        //////////////////////////////
        x5 = Draw.convertCoordinateX(parseInt((x + cd / 2) - (z + cr / 2) * a));
        y5 = Draw.convertCoordinateY(parseInt(y + cc - (z + cr / 2) * a));

        x6 = Draw.convertCoordinateX(parseInt((x - cd / 2) - (z + cr / 2) * a));
        y6 = Draw.convertCoordinateY(parseInt(y + cc - (z + cr / 2) * a));

        x7 = Draw.convertCoordinateX(parseInt((x - cd / 2) - (z - cr / 2) * a));
        y7 = Draw.convertCoordinateY(parseInt(y + cc - (z - cr / 2) * a));

        x8 = Draw.convertCoordinateX(parseInt((x + cd / 2) - (z - cr / 2) * a));
        y8 = Draw.convertCoordinateY(parseInt(y + cc - (z - cr / 2) * a));
        ...
        Draw.drawText(ctx, x1, Draw.convertCoordinateY(parseInt(y - (z + cr / 2) * a) - 5), 'A');
        Draw.drawText(ctx, x2, Draw.convertCoordinateY(parseInt(y - (z + cr / 2) * a) - 5), 'B');
        Draw.drawText(ctx, x3, Draw.convertCoordinateY(parseInt(y - (z - cr / 2) * a) - 5), 'C');
        Draw.drawText(ctx, x4, Draw.convertCoordinateY(parseInt(y - (z - cr / 2) * a) - 5), 'D');
        Draw.drawText(ctx, x5, Draw.convertCoordinateY(parseInt(y + cc - (z + cr / 2) * a) + 1), 'E');
        Draw.drawText(ctx, x6, Draw.convertCoordinateY(parseInt(y + cc - (z + cr / 2) * a) + 1), 'F');
        Draw.drawText(ctx, x7, Draw.convertCoordinateY(parseInt(y + cc - (z - cr / 2) * a) + 1), 'G');
        Draw.drawText(ctx, x8, Draw.convertCoordinateY(parseInt(y + cc - (z - cr / 2) * a) + 1), 'H');
        this.setState({
            rect: {
                ...this.state.rect,
